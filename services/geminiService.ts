...
const metadataSchema = {
    ...
    properties: {
        ...
        description: {
            type: Type.STRING,
            description: "The meta description of the page, or a concise one-sentence summary if no meta description is found."
        }
    },
    required: ["title", "description"]
};

export const fetchLinkMetadata = async (url: string): Promise<[string, string]> => {
    if (!API_KEY) {
    ...
    try {
        ...
        throw new Error("Failed to fetch metadata. The URL might be inaccessible or the content is protected.");
    }
};
